<template>
    <div>
        <h2 class="assignTitle">禁毒宣传</h2>
        <el-row style="justify-content: flex-end;display: flex;margin-right: 50px">
            <el-button type="primary" icon="el-icon-edit" @click="setContent">添加禁毒宣传</el-button>
        </el-row>
        ...
        <div>
            <el-dialog title="上传禁毒宣传资料" :visible.sync="dialogFormVisible" :append-to-body="true">
        ...
        <div>
            <el-dialog title="禁毒宣传正文" :visible.sync="dialogFormVisible1" :append-to-body="true">
