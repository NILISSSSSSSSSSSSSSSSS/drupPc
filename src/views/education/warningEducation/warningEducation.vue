<template>
    <div>
        <h2 class="assignTitle">警示教育</h2>
        <el-row style="justify-content: flex-end;display: flex;margin-right: 50px">
            <el-button type="primary" icon="el-icon-edit" @click="setContent">添加警示教育</el-button>
        </el-row>
        ...
        <div>
            <el-dialog title="上传警示教育资料" :visible.sync="dialogFormVisible" :append-to-body="true">
        ...
        <div>
            <el-dialog title="警示教育正文" :visible.sync="dialogFormVisible1" :append-to-body="true">
